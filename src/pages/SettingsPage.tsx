...
const tabs = [
  ...
  { id: 'security', label: '계정 설정', icon: Shield },
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-4 gap-6">
        <aside className="rounded-lg border border-white/60 bg-white/85 p-4 shadow-lg backdrop-blur-xl">
        ...
        <section className="col-span-3 rounded-lg border border-white/60 bg-white/85 p-8 shadow-lg backdrop-blur-xl">
...
function ProfileSettings() {
  return (
    <div className="space-y-6">
      <h3 className="text-xl font-bold text-gray-900">프로필</h3>
      <div className="flex items-center gap-6">
        ...
        <div>
          <button type="button" className="mb-2 rounded-lg bg-gradient-to-r from-blue-600 to-indigo-600 px-4 py-2 font-medium text-white transition-all hover:shadow-lg">
            사진 변경
          </button>
          <p className="text-sm text-gray-600">JPG, PNG 최대 5MB</p>
        </div>
      </div>
      ...
      <div className="flex justify-end gap-3 pt-4">
        <button type="button" className="rounded-lg border border-gray-200/50 bg-white px-6 py-3 font-medium text-gray-700 transition-all hover:bg-gray-50">
          취소
        </button>
        <button type="button" className="rounded-lg bg-gradient-to-r from-blue-600 to-indigo-600 px-6 py-3 font-medium text-white transition-all hover:shadow-lg">
          저장
        </button>
      </div>
    </div>
...
function SecuritySettings() {
  return (
    <div className="space-y-6">
      <h3 className="text-xl font-bold text-gray-900">계정 설정</h3>
      <div className="space-y-4">
        <div className="rounded-lg border border-gray-200/50 bg-white/90 p-4">
          <div className="flex items-center justify-between">
            ...
            <button type="button" className="rounded-lg bg-gradient-to-r from-blue-600 to-indigo-600 px-4 py-2 font-medium text-white transition-all hover:shadow-lg">
              변경
            </button>
          </div>
        </div>
        <SettingToggle label="2단계 인증" desc="계정 보안을 강화합니다." />
        <div className="rounded-lg border border-gray-200/50 bg-white/90 p-4">
          ...
          <div className="flex items-center justify-between rounded-lg bg-blue-50/50 p-3">
            <div>
              ...
              <p className="text-xs text-gray-600">현재 세션</p>
            </div>
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <div className="grid grid-cols-3 gap-4">
          {['라이트', '다크', '시스템'].map((theme, index) => (
            <button key={theme} type="button" className={`rounded-lg border-2 p-4 transition-all ${index === 0 ? 'border-blue-600 bg-blue-50/50' : 'border-gray-200/50 bg-white/90 hover:border-blue-300'}`}>
