...
export const defaultDashboardWidgets: WidgetItem[] = [
  ...
  { id: 'calendar', type: 'calendar', title: '캘린더', colSpan: 1, rowSpan: 4, order: 4 },
  { id: 'education', type: 'education-content', title: '교육 자료 제작', colSpan: 1, rowSpan: 4, order: 5 },
  { id: 'monthly-calendar', type: 'monthly-calendar', title: '캘린더', colSpan: 1, rowSpan: 4, order: 6 },
  { id: 'notification', type: 'notification', title: '알림', colSpan: 1, rowSpan: 4, order: 7 },
];
...
export const widgetOptions: WidgetOption[] = [
  ...
  },
  {
    type: 'calendar',
    title: '캘린더',
    description: 'Compliance 관련 일정 및 마감일',
    icon: Calendar,
    color: 'text-blue-600',
    bgColor: 'bg-blue-100',
    defaultSize: { colSpan: 1, rowSpan: 4 },
  ...
  },
  {
    ...
    title: '캘린더',
    description: '월간 일정 현황을 달력 형태로 확인',
    icon: Calendar,
    color: 'text-blue-600',
    bgColor: 'bg-blue-100',
    defaultSize: { colSpan: 1, rowSpan: 4 },
