...
const vietnameseDictionary: Record<string, string> = {
  ...
  '법무팀': 'Đội pháp vụ',
  '준법감시부': 'Bộ phận giám sát tuân thủ',
  ...
  '이사회 결의가 필요한 주요 사항은?': 'Những vấn đề chính cần nghị quyết của hội đồng quản trị là gì?',
  ...
  '준법 자문 권한': 'Quyền tư vấn tuân thủ',
...
const englishDictionary: Record<string, string> = {
  ...
  '이사회 결의가 필요한 주요 사항은?': 'What key matters require a board resolution?',
  ...
  '준법 자문 권한': 'Compliance advisory permission',
...
const khmerDictionary: Record<string, string> = {
  ...
  '법무팀': 'ក្រុមច្បាប់',
  '준법감시부': 'ផ្នែកត្រួតពិនិត្យអនុលោមភាព',
  '박준호': 'Park Junho',
  '과장': 'អ្នកគ្រប់គ្រង',
  '한국어': 'កូរ៉េ',
  '영어': 'អង់គ្លេស',
