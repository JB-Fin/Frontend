...
const vietnameseDictionary: Record<string, string> = {
  '준또배기 컴플라이언스 AI 플랫폼에 오신 것을 환영합니다.': 'Chào mừng bạn đến với nền tảng AI tuân thủ JunttoBaegi.',
  '준또배기': 'JunttoBaegi',
  'JB금융그룹': 'Tập đoàn Tài chính JB',
  '컴플라이언스 AI': 'AI tuân thủ',
  '컴플라이언스팀': 'Đội tuân thủ',
  '컴플라이언스 전문 AI': 'AI chuyên về tuân thủ',
  '플랫폼': 'Nền tảng',
  ...
  '위젯을 드래그해서 대시보드 레이아웃을 자유롭게 구성하세요.': 'Kéo thả tiện ích để tùy chỉnh bố cục bảng điều khiển.',
  '대시보드에 추가할 위젯을 선택하세요.': 'Chọn tiện ích để thêm vào bảng điều khiển.',
  ...
  '위젯을 추가하여 대시보드를 구성하세요.': 'Thêm tiện ích để tạo bảng điều khiển.',

  '안녕하세요! JB금융그룹 컴플라이언스 AI 어시스턴트입니다. 무엇을 도와드릴까요?': 'Xin chào! Tôi là trợ lý AI tuân thủ của Tập đoàn Tài chính JB. Tôi có thể giúp gì cho bạn?',
  '안녕하세요. JB금융그룹 컴플라이언스 AI 어시스턴트입니다. 규정, 법령, 내부 정책에 대해 무엇이든 물어보세요.': 'Xin chào. Tôi là trợ lý AI tuân thủ của Tập đoàn Tài chính JB. Hãy hỏi tôi về quy định, pháp luật hoặc chính sách nội bộ.',
  '추천 질문': 'Câu hỏi gợi ý',
  '추천 질문:': 'Câu hỏi gợi ý:',
  ...
  '신규 대출 상품 출시 전 컴플라이언스 체크리스트': 'Danh sách kiểm tra tuân thủ trước khi ra mắt sản phẩm vay mới',
  ...
  '컴플라이언스 관련 질문을 입력하세요...': 'Nhập câu hỏi liên quan đến tuân thủ...',
  'AI 어시스턴트': 'Trợ lý AI',
  ...
  '컴플라이언스 일정 및 이벤트 관리': 'Quản lý lịch và sự kiện tuân thủ',
  '일정 추가': 'Thêm lịch',
  '오늘': 'Hôm nay',
  '오늘의 일정': 'Lịch hôm nay',
  ...
  '부서': 'Bộ phận',
  '직책': 'Chức danh',
  '선임 컴플라이언스 매니저': 'Quản lý tuân thủ cấp cao',
